...
class Bronze():
    ...
    def consume_user_registration(self, once=True, processing_time="5 seconds"):
        ...
        self.spark.sparkContext.setLocalProperty("self.spark.scheduler.pool", "bronze_p2")
    ...
    def consume_kafka_multiplex(self, once=True, processing_time="5 seconds"):
        ...
        df_date_lookup = self.spark.table(f"{self.db_name}.date_lookup").select("date", "week_part")
        ...
        self.spark.sparkContext.setLocalProperty("self.spark.scheduler.pool", "bronze_p1")
